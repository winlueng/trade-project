...
<header id="Header" class="kb_header flexLayout-center">
    ...
    <script>
        ...
        Url="<?php echo U('WasteBook/reset_password');?>";
        $.ajax({
            type:"POST",
            url:Url,
            ...
            success:function(data){
                if(data.status == 'true'){
                    ...
                    Alert(data.err_msg);
                    var url = 'http://<?php echo ($_SERVER["HTTP_HOST"]); echo U("WasteBook/reset_password");?>?companyName=<?php echo I("get.companyName");?>&tem=<?php echo I("get.tem");?>';
                    setTimeout("window.location.href='"+url+"'",3000);
                }
            },
