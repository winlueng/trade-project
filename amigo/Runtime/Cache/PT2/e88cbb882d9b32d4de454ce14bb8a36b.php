...
<?php if(empty($list)): ?><p class="tc mt20">暂无明细哦~</p>
<?php else: ?>
<?php if(is_array($list)): foreach($list as $key=>$v): ?><article class="kb_list-cell ">  
    
    <aside class="kb_list-cell-bd">
        <h2 class="kb_list-cell-title mb10"><?php echo ($v['system_remark']); ?></h2>
        <p class="kb_list-cell-brief"> <?php echo wechatPayTime($v['pay_time']);?></p>
    </aside>
    <div class="kb_list-cell-ft">
       <?php echo ($v['recharge_or_buy'] == '1'?'+':'-'); echo ($v['recharge_total']); ?>
    </div>
