...
<script src="/Public/trading/script/module/mobiscroll/mobiscroll.2.13.2.js"></script>
<link href="/Public/trading/script/module/mobiscroll/mobiscroll.2.13.2.css?t=1" rel="stylesheet" />
...
<div class="dl_selfmain-content">
    ...
    <a href="javascript:;" class="kb_cell kb_cell-href">
     <p class="kb_cell-bd">
      <label class="kb_fileBox imgW imgH">
        ...
        <?php if(empty($userInfo["head_portrait"])): ?><img src="/Public/Portal/PortalImages/1.jpg">
        <?php else: ?>
        <img src="<?php echo ($userInfo[head_portrait]); ?>"><?php endif; ?>
      </label>
     </p>
     <p class="kb_cell-ft">
         <em>修改头像</em>
  ...
  <actricle class="kb_cells">
   <a href="#/nickName" class="kb_cell kb_cell-href">
    <p class="kb_cell-bd">
        呢称<em class="tg_ft-yellow">*</em>
    </p>
    <p class="kb_cell-ft">
        <em><?php echo ($userInfo[nick_name]); ?></em>
    </p>
   </a>
   <a href="#/realName" class="kb_cell kb_cell-href">
    ...
    <p class="kb_cell-ft">
        <em><?php echo ($userInfo[real_name]); ?></em>
    </p>
   </a>
   <a href="javascript:;" class="kb_cell kb_cell-href mark-sltSex">
    ...
    <p class="kb_cell-ft">
        <em><?php echo ($userInfo[sex]==1?'男':女); ?></em>
    </p>
   </a>
   <a href="javascript:;" class="kb_cell kb_cell-href">
    ...
    <p class="kb_cell-ft">
        <em><?php echo date('Y-m-d', $userInfo['visitor_birthday']);?></em>
    </p>
   </a>
    <a href="#/nowcity" class="kb_cell kb_cell-href">
     ...
     <p class="kb_cell-ft">
        <em><?php echo ($userInfo[address]); ?></em>
     </p>
   </a>
    <a href="#/verifytel" class="kb_cell kb_cell-href">
    <p class="kb_cell-bd">
        手机号<em class="tg_ft-yellow">*</em>
    </p>
    <p class="kb_cell-ft">
  ...
  <section class="dl-loginContent  bc ">
      <form action="<?php echo U('Login/visitorSignIn');?>" method="post">
          ...
          <input type="submit" value="确定" class="h50 kb_btn kb_btn-main w  mark-registerSub " />
      </form>
  </section>
...
<div class="sltSexAlert">
  ...
  <article class="kb_cell kb_cell-check">
    ...
    <p class="kb_cell-ft kb_choose">
      <input type="radio" name="sex" value="1" <?php echo ($userInfo[sex]==1?'checked':''); ?> />
      <span class=" kb_choose-check">
        <b class="kb_choose-check-default kb_choose-check_default"></b>
      </span>
    </p>
  ...
  <article class="kb_cell kb_cell-check">
    ...
    <p class="kb_cell-ft kb_choose">
      <input type="radio" name="sex" value="2" <?php echo ($userInfo[sex]==2?'checked':''); ?> />
      <span class=" kb_choose-check">
        <b class="kb_choose-check-default kb_choose-check_default"></b>
      </span>
    </p>
...
$(function(){
  ...
  var res = $('#Main');
   ...
   R.route('/nickName', function() {
      ...
      $('.mark-selfSub').show();
      $('.kb_header-title').text('呢称');
      $('.mark-userData').val('<?php echo ($userInfo[nick_name]); ?>');
   ...
   R.route('/realName', function() {
      ...
      $('.mark-userData').val('<?php echo ($userInfo[real_name]); ?>');
    ...
    R.route('/nowcity', function() {
      ...
      $('.mark-userData').val('<?php echo ($userInfo[address]); ?>');
