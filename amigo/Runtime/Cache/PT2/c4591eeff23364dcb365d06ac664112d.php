...
<body>
 ...
 <label class="kb_choose  kb_choose-icon">
  ...
  <section id="Main" class="kb_main bc tg_classification dl_classDetail">
    ...
    <?php if(!$goodsInfo['company_id']): ?><div class="kb_list-cell-hd">
    ...
    <article class="main_bg p10 mb10">
      ...
      <?php if(($goodsInfo['is_discount'] == '1') AND ($goodsInfo['sales_start_time'] < time()) AND ($goodsInfo['sales_end_time'] > time())): ?><em class="f16 mr10">￥<?php echo ($goodsInfo['price'] * ($goodsInfo['discount']/10)); ?>元</em>
      ...
      <div class="tg_cell dl_classOpera h">
          <div class="tg_cell-hd flexLayout-center h">
           <!--  <a href="javascript:;" class="tg_cell-bd h">
            ...
            <a href="<?php echo U('Index/index');?>" class="tg_cell-bd h">
                <p class="icon-gohone h20 mt5  w"></p>
                <p class="tc mt5">首页</p>
            </a>
            <a href="<?php echo U('ShoppingCart/myCart');?>?c_com=g&gid=<?php echo I('get.id');?>" class="tg_cell-bd h">
      ...
      (function(){
        ...
        $('.mark-sltShopSub').on('click',function(){
            ...
            var attributeid,goodsid,goodsNum,
                ...
                url="<?php echo U('ShoppingCart/insertCart');?>";
            ...
            if(way==1){
              ...
              $('#sltShopBuyForm').attr('action',"<?php echo U('OrderForm/unpaid');?>?way=1");
