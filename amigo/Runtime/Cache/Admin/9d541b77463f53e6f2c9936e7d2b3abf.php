    ...
    <div id="kbVipAdmin_rightCenter" class="OrderForm">
        ...
        <div class="main-contentBox kbVipAdmin_mt24" >
                ...
                <table>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <p><?php echo ($v["address_id"]["consignee"]); ?> <?php echo ($v["address_id"]["phone"]); ?>  </p><br>
                                <p><?php echo ($v["address_id"]["address_str"]); ?></p><br>
                            </td>
                            <td>
                                <?php echo ($v['pay_type'] == '1'?'微信支付':'钱包支付'); ?>
                            </td>
                            <?php switch($v["status"]): case "0": ?><td><p>待付款</p></td>
                                ...
                                <?php case "2": switch($v["is_send_out"]): case "0": ?><td><p>已付款,待发货</p></td>
                                            <td>
                                                ...
                                                <p class="mb10">
                                                    <input class="kbVipAdmin_opt  h30 tc shipGoods" title="家下就发货" orderID="<?php echo ($v["id"]); ?>" type="button" value="发货" />
                                                </p><?php break;?>
                                ...
                                <?php case "7": switch($v["is_send_out"]): case "0": ?><td><p>未发货,拒绝退款</p></td>
                                    ...
                                    <p class="mb10">
                                    <a class="kbVipAdmin_button_eee " href="<?php echo U('OrderForm/orderDetailByProject', ['id' => $v['id'],'module' => $_GET['module']]);?>">订单详情</a>
                                    </p>
                                </div>
                            </td>
            ...
            <div class="kbVipAdmin_page">
                ...
                <div class="pageJump">
                <form action="<?php echo U('projectOrderList',['module' => $_GET['module'], 'status' => $_GET['status']]);?>"> 
...
<script type="text/javascript" src="/Public/Portal/PortalJS/portal.js?version=9.7"></script>
	...
	<script type="text/javascript">
		...
		for(var i = 0;i < nav_a.length;i ++)
		{
			...
			if($('.left_nav a:eq('+i+')').attr('active') == '/Admin/OrderForm/projectOrderList'+'.html')
			{
