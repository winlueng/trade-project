			...
			<div class="kbVipAdmin_table mb20	">
				<table>
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
							...
							<td>
								<p class="mb10">
									<a href="<?php echo U('WechatRefund/orderDetailByProject',['id' => $v['id'],'module' => $_GET['module']]);?>" class=" kbVipAdmin_button_eee">查看</a>
								</p>
...
<script type="text/javascript" src="/Public/Portal/PortalJS/portal.js?version=9.7"></script>
	...
	<script type="text/javascript">
		...
		for(var i = 0;i < nav_a.length;i ++)
		{
			...
			if($('.left_nav a:eq('+i+')').attr('active') == '/Admin/WechatRefund/orderListByProject'+'.html')
			{
