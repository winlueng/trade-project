                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <div class="kbVipAdmin_tdAction">
                                  ...
                                  <!--   <input class=" kbVipAdminStaff mb10" type="button" visitorID="<?php echo ($v["id"]); ?>" value="" title="通过"  />
                                    <input class=" kbVipAdminHistorty mb10" type="button" visitorID="<?php echo ($v["id"]); ?>" nickName="<?php echo ($v["nick_name"]); ?>" value="" title="拒绝"  /> -->
                                </div>
                            </td>
...
<script type="text/javascript" src="/Public/Portal/PortalJS/portal.js?version=9.7"></script>
	...
	<script type="text/javascript">
		...
		for(var i = 0;i < nav_a.length;i ++)
		{
			...
			if($('.left_nav a:eq('+i+')').attr('active') == '/Admin/GoodsStick/coalitionGoods'+'.html')
			{
