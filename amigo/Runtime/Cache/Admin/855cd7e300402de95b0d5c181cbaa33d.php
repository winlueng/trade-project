        ...
        <tbody>
          <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                ...
                <td class="kbVipAdmin_tdAction">
                    <label class="kb_choose  ml5">
                        <input type="checkbox" value="" title="激活" class="mark-cardActivation" <?php echo ($vo['status']=='1'?'checked':''); ?> data-cardNum='<?php echo ($vo["card_number"]); ?>' />
...
<script type="text/javascript" src="/Public/Portal/PortalJS/portal.js?version=9.7"></script>
	...
	<script type="text/javascript">
		...
		for(var i = 0;i < nav_a.length;i ++)
		{
			...
			if($('.left_nav a:eq('+i+')').attr('active') == '/Admin/RechargeCard/not_use_card_info'+'.html')
			{
