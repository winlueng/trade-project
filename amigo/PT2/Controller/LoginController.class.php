...
class LoginController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->loginObj = new \PT2\Model\LoginModel();
        $this->obj      = new \PT2\Model\WechatVisitorModel;
    }
	...
	{
        $redirect_uri  = 'http://'.$_SERVER['HTTP_HOST'].'/'.MODULE_NAME.'/Login/showInfo/';
    ...
    public function showInfo()
    {
        ...
        // $this->redirect(session('temporary_url'));exit;
