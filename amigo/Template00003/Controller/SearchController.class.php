...
class SearchController extends CommonController
{
	...
	{
		/*$res = $this->search->setFuzzy()->setQuery('company_id:'. $this->companyInfo['id'] .' 士大夫')->setLimit(30)->setSort('addtime', true)->search();
		dump($res);exit;*/
	...
	public function goSearch()
	{
		...
		$res = $this->search->setFuzzy()->setQuery($word)->setLimit(60)->setSort('addtime', true)->search();
