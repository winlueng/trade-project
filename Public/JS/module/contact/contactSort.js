...
$(function(){
        ...
        initials();
         ...
         $(".initials ul li").click(function(){
            ...
            setTimeout(function(){
                Initials.css('background','rgba(255,255,255,1)');
                LetterBox.fadeOut();
            },1000);

            var _index = _this.index()
            if(_index==0){
                $('.kbShopAdmin_sltExpress').animate({scrollTop: '0px'}, 300);//点击第一个滚到顶部
            }else if(_index==27){
                var DefaultTop=document.getElementById('default').offsetTop;
                $('.kbShopAdmin_sltExpress').animate({scrollTop: DefaultTop+'px'}, 300);//点击最后一个滚到#号
            }else{
                ...
                if($('#'+letter).length>0){
                    ...
                    $('.kbShopAdmin_sltExpress ').animate({scrollTop: LetterTop-145+'px'}, 300);
                }
            }
        })
