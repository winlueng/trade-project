    ...
    $.datepickerjQ = function(){
       $(".ui-datepicker-time").on("click",function(){
           var $this=$(this),
            ...
            if(sPosition.top<2&&sPosition.left==0){
...
//            getAppCondtion();
        ...
        $(".ui-datepicker-quick input").on("click",function(){
            ...
            console.log(new Date().getMilliseconds())
               start=Date.parse(new Date(newDate[0]));
               end=Date.parse(new Date(newDate[1]));
...
$(function(){
    ...
    function timeConfig(time){
        ...
        var endDateStr = nowDate.getFullYear() + '/'+  (nowDate.getMonth()+1) + '/' + nowDate.getDate();
        if(time == 0){
            endDateStr +='一'+endDateStr+" "+nowDate.getHours()+':'+nowDate.getMinutes()+':'+nowDate.getSeconds();
        }else{
            endDateStr += timeStr;
        }
        return endDateStr;
